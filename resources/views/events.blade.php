					...
					<div class="row">
								...
								<div class="usr-question">
									...
									<div class="usr_quest">
										...
										<ul class="react-links">
											<li><a href="#" title=""><i class="fas fa-heart"></i> Nom de la chaîne</a></li>
										</ul>
										<ul class="quest-tags">
									...
									<span class="quest-posted-time"><i class="fa fa-clock-o"></i>Date de début</span>
						...
						<div class="col-lg-4">
							<div class="widget widget-user">
								<h3 class="title-wd">Evenement à ne pas manquer</h3>
								<ul>
									<li>
